...
class SplashScreenValues extends StatefulWidget {
  ...
  factory SplashScreenValues.timer(
  ...
  factory SplashScreenValues.network(
...
class _SplashScreenState extends State<SplashScreenValues> {
  @override
  void initState() {
    super.initState();
    ...
    if (widget.navigateAfterFuture == null) {
      Timer(Duration(seconds: widget.seconds), () {
        if (widget.navigateAfterSeconds is String) {
          ...
          Navigator.of(context).pushAndRemoveUntil(widget.navigateAfterSeconds, (Route<dynamic> route) => false,);
      ...
      widget.navigateAfterFuture.then((navigateTo) {
        if (navigateTo is String) {
          // It's fairly safe to assume this is using the in-built material
          // named route component
          Navigator.of(context).pushNamedAndRemoveUntil(navigateTo, (Route<dynamic> route) => false,);
        } else if (navigateTo is Widget) {
          Navigator.of(context).pushAndRemoveUntil(widget.pageRoute != null
              ? widget.pageRoute
              : new MaterialPageRoute(
              settings:
              widget.routeName != null ? RouteSettings(name: "${widget.routeName}") : null,
              builder: (BuildContext context) => navigateTo), (Route<dynamic> route) => false);
        } else {
                  ...
                  child: new Container(
                      child: new Column(
                        ...
                        children: <Widget>[
                          ...
                          Image.asset('assets/slogan.png', width: MediaQuery.of(context).size.width*0.8,)
                        ],
                      )),
                ),
                Expanded(
